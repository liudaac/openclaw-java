 ...
 * @version 2026.3.9
 */
public record ToolExecuteContext(
        String toolName,
    ...
    /**
     * Creates a builder for ToolExecuteContext.
     *
    ...
    /**
     * Builder for ToolExecuteContext.
     */
    public static class Builder {
        ...
        public ToolExecuteContext build() {
            return new ToolExecuteContext(
                    toolName,
                    arguments,
