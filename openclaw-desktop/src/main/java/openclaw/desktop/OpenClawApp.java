 ...
 * @version 2026.3.24
 */
@SpringBootApplication(scanBasePackages = {"openclaw.desktop", "openclaw.server", "openclaw.cron", "openclaw.browser", "openclaw.session", "openclaw.memory", "openclaw.tools", "openclaw.gateway"})
